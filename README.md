...
- `POST /api/public/supplier-connection` (retailer onboarding email, Vercel Function in `web/api`)
...
3. Set `RESEND_API_KEY`, `RETAILER_SIGNUP_EMAIL_FROM`, and `RETAILER_SIGNUP_EMAIL_TO` in Vercel to send retailer enquiries to the EANrunner onboarding inbox. Do not expose these values as `VITE_` variables.
